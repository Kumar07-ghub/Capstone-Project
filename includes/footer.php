...
<!-- Responsive Footer -->
<footer style="background-color: #2C3E50;" class="text-white pt-5 pb-4 mt-5">
=======
<?php
...
<<<<<<< HEAD
                <h5 class="text-uppercase mb-4 fw-bold">The Indian Supermarket</h5>
                <p>Your one-stop shop for daily essentials, fresh produce, and home needs. Fast delivery, great prices,
=======
...
<<<<<<< HEAD
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                ...
                <p><i class="bi bi-geo-alt-fill me-2"></i>509 Wilson Ave #20, Kitchener, ON N2C 2M4</p>
                <p><i class="bi bi-envelope-fill me-2"></i>support@indiansupermarket.com</p>
                <p><i class="bi bi-phone-fill me-2"></i>+1 (519) 893-8444</p>
=======
...
<<<<<<< HEAD
                <h5 class="text-uppercase mb-4 fw-bold">Find Us on Map</h5>
=======
...
>>>>>>> e52701a (Update existing files from local folder)
        ...
        <div class="row align-items-center text-center text-md-start">
            <div class="col-md-6">
<<<<<<< HEAD
                <p class="mb-0">&copy; 2025 The Indian Supermarket. All rights reserved.</p>
            </div>
