<?php
session_start();
$meta_description = "Buy and add rating to products online at The Indian Supermarket. Quality groceries delivered to your door.";
...
<div class="container my-5">
    ...
    <div class="mt-5">
        ...
        <?php
        $reviewStmt = $conn->prepare("SELECT r.rating, r.review, r.created_at, 
