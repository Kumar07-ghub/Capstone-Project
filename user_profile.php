<?php
session_start();
$meta_description = "View and manage your account at The Indian Supermarket. Update personal details and track your orders easily.";
        ...
        <div class="card shadow-sm rounded-4 border-0">
          <div class="card-body text-center">
            ...
            <div class="mb-3 mx-auto" style="width: 150px; height: 150px; overflow: hidden; border-radius: 50%; border: 3px solid #198754; box-shadow: 0 0 8px rgba(25, 135, 84, 0.5);">
              <img src="<?= !empty($user['photo']) ? htmlspecialchars($user['photo']) : 'img/customer2.jpg' ?>" alt="Profile photo" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
